    ...
    module Commands
      ...
      class New < Command # rubocop:disable Metrics/ClassLength
        ...
        def generate_app(context)
          Hanami::CygCLI::Commands::New::App.new(out: @out, files: @files).call(app: context.application_name, application_base_url: context.application_base_url, **context.options)
        end
